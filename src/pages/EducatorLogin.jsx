...
import { BookOpen, Briefcase, AlertCircle } from 'lucide-react';
import styles from './Login.module.css';

export const EducatorLogin = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (result.success && result.user.role === 'educator') {
            navigate('/educator');
        } else if (result.success && result.user.role !== 'educator') {
            setError('This account is not an educator account');
        } else {
